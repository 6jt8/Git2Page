...
const getFormattedMastodonValue = (
  ...
  const normalized = mastodonValue.startsWith('@')
    ? mastodonValue.substring(1)
    : mastodonValue;
  const [username, server] = normalized.split('@');
            ...
            <Fragment>
              ...
              {social?.discord && (
                <ListItem
                  ...
                  link={
                    social.discord.startsWith('http')
                      ? social.discord
                      : `https://discord.gg/${social.discord}`
                  }
                />
              )}
            </Fragment>
